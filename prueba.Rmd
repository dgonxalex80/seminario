...
names(datos) = c("Carrera", "Matriculados", "Ubicados", "Rotando", "Aplazados","Porcentaje de ubicación %")
...
# Tu conjunto de datos
datos <- data.frame(
  Carrera = c("Adninistración de Empresas", "Arquitectura", "Artes Visuales","Biología","Ciencia Política","Comunicación","Contaduría Pública","Derecho","Diseño de Comunicación Visual","Economía","Filosofía","Finanzas","Ingeniería Civil","Ingeniería de Sistemas y Computación","Ingeniería Electrónica","Ingeniería Industrial","Ingeniería Mecánica","Matemáticas Aplicadas","Mercadeo","Negocios Internacionales","Nutrición y Dietética","Psicología", "TOTAL"),
  ...
  Porcentaje_Ubicacion = c(.97, .95, .67,.75,.92,1.00,1.00,1.00,.96,.94,.67,1.00,.88,1.00,1.00,1.00,1.00,1.00,1.00,.90,1.00,.99,94)
)

names(datos) = c("Carrera", "Matriculados", "Ubicados", "Rotando", "Aplazados","Porcentaje de ubicación")

# Crear la tabla formateada
tabla_formateada2 <- formattable(datos)
